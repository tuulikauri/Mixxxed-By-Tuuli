...
// * Author: DJ Tuuli (August 2025)
// * Edits to the 2019 mapping by DJ Phatso and Kerrick Staley for a Channel 3 and 4 Deck
// Changes:
// - Uses Decks 3 and 4:
//    either by adding 2 to 'decks' variables 
//    or editing [Channel1], [Channel2] to refer to 3 and 4.
...
DJCStarlight.init = function() {
    ...
    engine.connectControl("[Channel3]","vu_meter_left","DJCStarlight.baseLEDUpdate");
    engine.connectControl("[Channel4]","vu_meter_right","DJCStarlight.baseLEDUpdate");
